    ...
    <div className="home-page container mx-auto py-6 px-4">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-2xl p-8 mb-10 shadow-lg">
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">En İyi Ürünler En Uygun Fiyatlarla</h1>
          <p className="text-lg mb-6">
            Elektronikten giyime, ev eşyalarından aksesuarlara kadar binlerce ürün sizleri bekliyor.
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center text-center">
          ...
          <p className="text-gray-600">Binlerce ürün kategorisiyle ihtiyacınız olan her şey tek bir yerde.</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center text-center">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center text-center">
          ...
          <p className="text-gray-600">Kredi kartı, havale ve kapıda ödeme seçenekleriyle güvenli alışveriş yapın.</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center text-center">
          <Headphones className="text-blue-600 mb-3" size={32} />
          <h3 className="font-bold text-lg mb-2">7/24 Destek</h3>
          <p className="text-gray-600">Sorularınız için müşteri hizmetlerimiz her zaman yanınızda.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div className="bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-xl p-6 shadow-md">
          <h3 className="text-xl font-bold mb-2">Elektronik Ürünlerde %20 İndirim</h3>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-700 text-white rounded-xl p-6 shadow-md">
          <h3 className="text-xl font-bold mb-2">100₺ Üzeri Alışverişlerde Kargo Bedava</h3>
          <p className="mb-4">Fırsattan yararlanmak için hemen alışverişe başlayın.</p>
      ...
      <div className="bg-white rounded-xl p-6 shadow-md mb-10">
        <h2 className="text-2xl font-bold mb-4">Türkiye'nin En Güvenilir Online Alışveriş Sitesi</h2>
        <p className="text-gray-700 mb-3">
          2023 yılında kurulan E-Ticaret sitemiz, müşterilerimize en kaliteli ürünleri en uygun fiyatlarla sunmayı 
          amaçlıyor. Müşteri memnuniyetini her zaman ön planda tutarak, güvenilir alışveriş deneyimi sunmayı ilke ediniyoruz.
        </p>
      ...
      <div className="bg-blue-100 rounded-xl p-8 text-center mb-6">
        <h3 className="text-2xl font-bold mb-3 text-blue-800">Hemen Üye Ol, Fırsatları Kaçırma!</h3>
        <p className="mb-6 text-blue-700">İlk alışverişinize özel %10 indirim ve düzenli kampanya bilgilendirmeleri için üye olun.</p>
